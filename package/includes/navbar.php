<div style="height: 82px;">
    <nav class="navbar navbar-expand-md navigation-clean navbar-light"
        ...
        <div class="container-fluid"><a class="navbar-brand" href="#"><img
                    ...
                    style="width: 160px;height: 70px;"></a><button data-bs-toggle="collapse" class="navbar-toggler"
...
;">
                                ...
                                <li>
                                    <form action="allcode.php" method="POST">
                                        <button type="submit" name="logout_btn" class="dropdown-item"
                                            style="color: #000; padding: 10px 20px; transition: background-color 0.3s;">Log
                                            out</button>
                                    </form>
                                </li>
                            </ul>
                ...
                <?php else: ?>
                    <form action="allcode.php" method="POST">
                        <ul class="nav-item" style="padding: 0px;padding-top: 12px;"><button class="btn btn-primary"
...
;padding-right: 12px;margin-right: 12px;">Sign
                                in</button><button class="btn btn-primary" type="submit" name="signup_btn"
